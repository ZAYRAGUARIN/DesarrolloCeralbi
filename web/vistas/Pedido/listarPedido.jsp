...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Pedidos</h1>
            <a class="btn btn-success" href="ControladorPedido?accion=add">Agregar Nuevo</a>
            <br>
            <br>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorPedido?accion=editar&id=<%= ped.getIdPed()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorPedido?accion=eliminar&id=<%= ped.getIdPed()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
