                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorVendedor?accion=editar&id=<%= ven.getIdVen()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorVendedor?accion=eliminar&id=<%= ven.getIdVen()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
