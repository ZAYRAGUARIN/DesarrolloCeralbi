                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorCliente?accion=editar&id=<%= cli.getIdCli()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorCliente?accion=eliminar&id=<%= cli.getIdCli()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
