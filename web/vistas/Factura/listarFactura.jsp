...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Facturas</h1>
            <a class="btn btn-success" href="ControladorFactura?accion=add">Agregar Nuevo</a>
            <br>
            <br>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorFactura?accion=editar&id=<%= fac.getIdfac()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorFactura?accion=eliminar&id=<%= fac.getIdfac()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
