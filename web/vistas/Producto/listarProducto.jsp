...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Productos</h1>
            <a class="btn btn-success" href="ControladorProducto?accion=add">Agregar Nuevo</a>
            <br>
            <br>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorProducto?accion=editar&id=<%= pro.getIdPro()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorProducto?accion=eliminar&id=<%= pro.getIdPro()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
