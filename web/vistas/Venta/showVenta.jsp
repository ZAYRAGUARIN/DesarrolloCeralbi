...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Ventas</h1>
            <a class="btn btn-success" href="ControladorVenta?accion=add">Agregar Nuevo</a>
            <br>
            <br>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorVenta?accion=editar&id=<%= objven.getIdVent()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorVenta?accion=eliminar&id=<%= objven.getIdVent()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
