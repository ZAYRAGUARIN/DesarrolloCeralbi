                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-warning" href="ControladorContacto?accion=editar&id=<%= con.getIdCon()%>">Editar</a>
                            <a class="btn btn-danger" href="ControladorContacto?accion=eliminar&id=<%= con.getIdCon()%>">Remove</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
