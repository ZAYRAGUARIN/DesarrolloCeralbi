...
public class ControladorFactura extends HttpServlet {
    ...
    Factura f =new Factura();//41- Modificar la declaración del objeto 
    FacturaDAO dao=new FacturaDAO(); //42- Modificar la declaración del objeto
    int id;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equalsIgnoreCase("listar")){
            ...
            float imp = Integer.parseInt(request.getParameter("txtImpuestos"));
