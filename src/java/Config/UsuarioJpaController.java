    ...
    public void create(Usuario usuario) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Cliente clienteListCliente : usuario.getClienteList()) {
                Usuario oldIdUsuOfClienteListCliente = clienteListCliente.getIdUsu();
                clienteListCliente.setIdUsu(usuario);
                clienteListCliente = em.merge(clienteListCliente);
                if (oldIdUsuOfClienteListCliente != null) {
                    oldIdUsuOfClienteListCliente.getClienteList().remove(clienteListCliente);
                    oldIdUsuOfClienteListCliente = em.merge(oldIdUsuOfClienteListCliente);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Cliente clienteListOldCliente : clienteListOld) {
                if (!clienteListNew.contains(clienteListOldCliente)) {
                    ...
                    illegalOrphanMessages.add("You must retain Cliente " + clienteListOldCliente + " since its idUsu field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Cliente clienteListNewCliente : clienteListNew) {
                if (!clienteListOld.contains(clienteListNewCliente)) {
                    Usuario oldIdUsuOfClienteListNewCliente = clienteListNewCliente.getIdUsu();
                    clienteListNewCliente.setIdUsu(usuario);
                    clienteListNewCliente = em.merge(clienteListNewCliente);
                    if (oldIdUsuOfClienteListNewCliente != null && !oldIdUsuOfClienteListNewCliente.equals(usuario)) {
                        oldIdUsuOfClienteListNewCliente.getClienteList().remove(clienteListNewCliente);
                        oldIdUsuOfClienteListNewCliente = em.merge(oldIdUsuOfClienteListNewCliente);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Cliente clienteListOrphanCheckCliente : clienteListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Usuario (" + usuario + ") cannot be destroyed since the Cliente " + clienteListOrphanCheckCliente + " in its clienteList field has a non-nullable idUsu field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
