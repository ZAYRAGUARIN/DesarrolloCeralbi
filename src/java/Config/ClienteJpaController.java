...
public class ClienteJpaController implements Serializable {
    ...
    public void create(Cliente cliente) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            Usuario idUsu = cliente.getIdUsu();
            if (idUsu != null) {
                idUsu = em.getReference(idUsu.getClass(), idUsu.getIdUsu());
                cliente.setIdUsu(idUsu);
            }
            ...
            if (idUsu != null) {
                idUsu.getClienteList().add(cliente);
    ...
    public void edit(Cliente cliente) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Usuario idUsuOld = persistentCliente.getIdUsu();
            Usuario idUsuNew = cliente.getIdUsu();
            ...
            if (idUsuOld != null && !idUsuOld.equals(idUsuNew)) {
                idUsuOld.getClienteList().remove(cliente);
                idUsuOld = em.merge(idUsuOld);
            }
            if (idUsuNew != null && !idUsuNew.equals(idUsuOld)) {
                idUsuNew.getClienteList().add(cliente);
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Usuario idUsu = cliente.getIdUsu();
            if (idUsu != null) {
                idUsu.getClienteList().remove(cliente);
                idUsu = em.merge(idUsu);
            }
            em.remove(cliente);
            utx.commit();
