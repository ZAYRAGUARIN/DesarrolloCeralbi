...
public class CategoriaDAO implements CRUDCategoria{
    ...
    public boolean add(Categoria cat) {
       String sql="insert into categoria(IdCat, NombreCat, Descripcion)values('"+cat.getIdCat()+"','"+cat.getNombreCat()+"','"+cat.getDescripcion()+"')";
        try {
            con=cn.getConnection();
            ps=con.prepareStatement(sql);
            ps.executeUpdate();
    ...
    public boolean edit(Categoria cat) {
        String sql="update categoria set IdCategoria='"+cat.getIdCat()+"',NombreCat='"+cat.getNombreCat()+"',Descripcion='"+cat.getDescripcion()+"' where IdCat="+cat.getIdCat();
        try {
            con=cn.getConnection();
            ps=con.prepareStatement(sql);
            ps.executeUpdate();
